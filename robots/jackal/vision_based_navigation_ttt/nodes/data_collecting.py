...
class collect_data():
    def __init__(self):
        ...
        self.linear_x_vel = 1 # note was not changed and accomodated from in the processing of the images
        # if it was used when collecting data then preprocessing of the images should not include dividing the values by the velocity
        self.angle_min = None
        self.angle_max = None
    ...
    def get_variables(self):
        path = os.environ["HOME"]+"/catkin_ws/src/vision_based_navigation_ttt/nodes/"
