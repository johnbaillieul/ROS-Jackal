...
class Controller:
	...
	def callback(self, data):
		...
		print('debug', self.mean_tau_l, self.mean_tau_r, self.mean_tau_c, self.mean_tau_el, self.mean_tau_er )
		perceive(self)
		print('sself',self.extreme_left, self.extreme_right, self.left, self.right)
		...
		print('obst', find_obstacle(self, self.mean_tau_center, self.time_to_turn)
		)
		# Set gain
		self.kp = 0.1
		self.kp_e = 0.2
