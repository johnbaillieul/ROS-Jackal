...
class Controller:
	...
	def __init__(self):
		...
		# Tau Data Subscriber
		self.tau_values = rospy.Subscriber("lidar_tau_values", TauComputation, self.callback)
