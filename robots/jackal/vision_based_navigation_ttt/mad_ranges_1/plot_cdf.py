...
rangess = [1,20,50,100]
for j in rangess:
    er_error_array_1 = pd.read_excel(path_folder + folder_name + str(j) +'_'+ count +'/er_error_array_mad_range_'+ str(j) + '_.xlsx')
    ...
    r_error_array_1 = pd.read_excel(path_folder + folder_name + str(j) +'_'+ count +'/r_error_array_mad_range_'+ str(j) + '_.xlsx')
    ...
    c_error_array_1 = pd.read_excel(path_folder + folder_name + str(j) +'_'+ count +'/c_error_array_mad_range_'+ str(j) + '_.xlsx')
    ...
    l_error_array_1 = pd.read_excel(path_folder + folder_name + str(j) +'_'+ count +'/l_error_array_mad_range_'+ str(j) + '_.xlsx')
    ...
    el_error_array_1 = pd.read_excel(path_folder + folder_name + str(j) +'_'+ count +'/el_error_array_mad_range_'+ str(j) + '_.xlsx')
...
plt.savefig(path_folder + "difranges.png")
plt.show()
